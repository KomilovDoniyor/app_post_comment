package test.app_post_comment.config;
...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("test.app_post_comment"))
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder().title("API Endpoints for POST COMMENT Web App")
